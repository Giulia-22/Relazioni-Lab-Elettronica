...
\noindent Il segnale ottenuto in uscita dopo aver attivato il pulsante set è stato riportato nella figure \ref{figura:TEK00016}, mentre l'uscita ottenuta dopo aver attivato il pulsante reset è visibile nella figure \ref{figura:TEK00017}. In quest'ultima figura non è presente l'impulso del reset siccome è stato visualizzato il segnale di set.

\begin{figure}[h!]
	\centering
	\includegraphics[height=6.5cm]{immagini/TEK00016}
	\caption{Risposta del circuito (ingresso sul set CH1 e uscita CH2).}
	\label{figura:TEK00016}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[height=6.5cm]{immagini/TEK00017}
	\caption{Risposta del circuito (ingresso sul set CH1 e uscita CH2).}
	\label{figura:TEK00017}
\end{figure}
\todo{non si vede impulso reset perchè l'ingresso è stato preso sul set e non sul reset}
