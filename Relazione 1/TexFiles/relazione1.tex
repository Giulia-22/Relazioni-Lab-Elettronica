...
\end{figure}
% Questa immagine è commentata perchè mi da errore
%\begin{figure}[h!]
%	\centering
%	\includegraphics[height=6.5cm]{immagini/fase_sper}
%	\caption{Diagramma di Bode della fase con misure}.}
...
% SCRIVERE ANCHE: andamento anomalo del bode ampiezza per comportamento in frequenza dell'opamp (vedi datasheet)
